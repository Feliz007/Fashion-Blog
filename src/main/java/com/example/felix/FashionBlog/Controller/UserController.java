...
//        log.info("Successfully Created A post With Title:  {} " , postDto.getTitle());
    ...
    public ResponseEntity<DeletePostResponse> delete(@PathVariable (value = "post_id") Integer post_id){
        log.info("Successfully Deleted A post With Title:  {} " );
        return new ResponseEntity<>(userService.deletePost(post_id), NO_CONTENT);
    }
    ...
    public ResponseEntity<Post> findPost(@PathVariable(  value = "id") Integer id){
