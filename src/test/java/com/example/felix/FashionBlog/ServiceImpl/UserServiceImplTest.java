...
class UserServiceImplTest {
    ...
    void setUp() {
        ...
        user = new User(1 , "felix" , "elemelefelix@gmail.com" , "Admin" , "12345" , localDateTime , localDateTime  , postList , commentList , likeList);
    ...
    @Test
    void register() {
        UserDto userDTO = new UserDto( "felix" , "elemelefelix@gmail.com" , "Admin" , "12345");
    ...
    void login_SuccessFullLogin() {
        LoginDto loginDto = new LoginDto("elemelefelix@gmail.com" , "12345");
        when(userRepository.findUserByEmail("elemelefelix@gmail.com")).thenReturn(Optional.ofNullable(user));
    ...
    void login_IncorrectPassword() {
        LoginDto loginDto = new LoginDto("elemelefelix@gmail.com" , "1238745");
        when(userRepository.findUserByEmail("elemelefelix@gmail.com")).thenReturn(Optional.ofNullable(user));
    ...
    void findUserByEmail() {
        when(userRepository.findUserByEmail("elemelefelix@gmail.com")).thenReturn(Optional.ofNullable(user));
        assertEquals(user , userService.findUserByEmail("elemelefelix@gmail.com"));
    }
}